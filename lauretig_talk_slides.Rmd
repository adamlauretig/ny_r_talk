...
- Ethnic Fractionalization and the Onset of Civil War **TODO: Title Check**
- Data and Code: **TODO: URL Here**
...
ggplot(data = predictions, aes(x = y, y = y_preds)) + 
  geom_jitter(width = .2, alpha = .3, size = .75) + 
  geom_jitter(data = predictions, aes(x = y, y = m1_preds), 
              width = .2, size = .75, alpha = .1, color = "red") + 
  theme_minimal() + 
  theme(
